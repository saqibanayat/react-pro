...
import { fetchAsyncMovieOrShowDetail, getSelectedMovieOrShow, removeSeletecMovieOrShow } from '../../features/movies/movieSlice';
const MovieDetail = () => {
    ...
    useEffect(() => {
        ...
        return ()=>{
            dispatch(removeSeletecMovieOrShow())
        }
    ...
    return (
        <>
            ...
            <div className="movie-section">
                ...
                {/* this method return the keys of "data"  */}
